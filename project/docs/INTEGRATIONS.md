...
- Реальный status: `CONNECTED`; OAuth и `GET /v1/models` успешно проверены вручную. Доступные model IDs: `GigaChat-2`, `GigaChat-2-Max`, `GigaChat-2-Pro`, `GigaChat-3-Lightning`, `GigaChat-3-Pro`, `GigaChat-3-Ultra`, `Embeddings`, `Embeddings-2`, `EmbeddingsGigaR`, `GigaEmbeddings-3B-2025-09`. Configured model присутствует. `chat/completions` не выполнялся.
